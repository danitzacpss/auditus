...
import { CheckIcon, StarIcon, ArrowRightIcon, EarIcon, HeartIcon, TargetIcon, ShieldIcon, AwardIcon } from '@/components/ui/Icon';
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl lg:text-2xl text-gray-600 mb-8 font-secondary leading-relaxed max-w-3xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {PROFESSIONALS.map((professional) => (
              <div key={professional.id} className="bg-white rounded-3xl shadow-lg p-8 text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <div className="w-24 h-24 mx-auto relative">
                    <div className="w-full h-full rounded-full flex items-center justify-center shadow-lg" 
                      ...
                      <div className="text-center">
                        <div className="text-2xl font-bold text-primary-blue">VC</div>
      ...
      <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 font-secondary max-w-2xl mx-auto">
              Los principios que nos guían en nuestro compromiso con la excelencia
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
              <div className="w-16 h-16 bg-gradient-to-br from-primary-blue to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <CheckIcon size="lg" className="text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2 font-primary">Excelencia</h3>
              <p className="text-gray-600 font-secondary text-sm">
                Formación continua y procedimientos de la más alta calidad
              </p>
            </div>

            <div className="text-center bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
              <div className="w-16 h-16 bg-gradient-to-br from-secondary-turquoise to-cyan-600 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <EarIcon size="lg" className="text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2 font-primary">Innovación</h3>
              <p className="text-gray-600 font-secondary text-sm">
            ...
            <div className="text-center bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
              <div className="w-16 h-16 bg-gradient-to-br from-pink-300 to-pink-400 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <HeartIcon size="lg" className="text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2 font-primary">Calidez Humana</h3>
              <p className="text-gray-600 font-secondary text-sm">
                Atención personalizada con trato cercano y profesional
              </p>
            </div>
            ...
            <div className="text-center bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2 font-primary">Confianza</h3>
              <p className="text-gray-600 font-secondary text-sm">
                Procedimientos seguros respaldados por experiencia profesional
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-primary-blue to-secondary-turquoise rounded-3xl p-8 lg:p-12 text-white text-center">
            <h2 className="text-3xl font-bold mb-4 font-primary">
              ¿Listo para conocer a tu fonoaudióloga?
            </h2>
            <p className="text-blue-100 mb-8 font-secondary text-lg leading-relaxed max-w-2xl mx-auto">
              Agenda tu cita y experimenta la diferencia de recibir atención auditiva profesional
