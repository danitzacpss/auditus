              ...
              >
                ...
                <div className="aspect-[4/5] sm:aspect-[3/4] lg:aspect-[4/5] relative rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 text-white transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <h3 className="text-sm lg:text-base font-semibold mb-1 font-poppins">
                      {photo.title}
                    </h3>
                  ...
                  {/* Ampliar text indicator */}
                  <div className="absolute bottom-4 right-4 px-2 py-1 bg-blue-600/80 backdrop-blur-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
